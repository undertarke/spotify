    ...
    <div>
      {page == "signin" ? (
        <div className="h-full">
          <div className="w-full p-9 bg-black">
            <svg
              role="img"
              viewBox="0 0 78 24"
              aria-label="Spotify"
          ...
          <div className="bg-[#2A2A2A] flex font-normal justify-center h-full items-center">
            <div className="bg-black w-[80] h-min-[90%] p-20 rounded-3xl">
                  ...
                  <div className="cursor-pointer ">
                    <div
                      ...
                      className={`w-[44px] h-[18px] flex  items-center rounded-full p-2  ${
                        on
                          ? "justify-start bg-[#727272]"
                          : "justify-end bg-[#1ED760]"
                      }`}
                    >
